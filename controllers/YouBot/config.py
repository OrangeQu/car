...
# ==================== 桌子边缘导航目标 ====================
# 四个木块分别从桌子的四个边缘放置
# 桌子尺寸 1.2m x 0.8m，中心在 (0, 0)
# 导航目标点距离桌子边缘约 0.1m 安全距离
TABLE_EDGE_TARGETS = {
    "red":    {"position": (0.0, 0.7),  "angle": -1.5708},  # 北侧，朝南（面向桌子中心）
    "blue":   {"position": (0.7, 0.0),  "angle": 3.14159},  # 东侧，朝西（面向桌子中心）
    "green":  {"position": (0.0, -0.7), "angle": 1.5708},   # 南侧，朝北（面向桌子中心）
    "yellow": {"position": (-0.7, 0.0), "angle": 0.0},      # 西侧，朝东（面向桌子中心）
}
